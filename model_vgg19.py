...
def get_symbol():
    ...
    style = mx.sym.Group([relu1_2, relu2_2, relu3_3, relu4_3])
    content = mx.sym.Group([relu2_2])
...
def get_executor(style, content, input_size, ctx):
    ...
    fname = mx.test_utils.download('https://github.com/dmlc/web-data/raw/master/mxnet/neural-style/model/vgg19.params')
    pretrained = mx.nd.load(fname)
